...
public class AjaxResult extends HashMap<String, Object> implements Serializable {
    ...
    public static AjaxResult create(BindingException e) {
//        return new AjaxResult(Result.failure, SpringApplicationContextAware.requestMessage().getText(e.getMessage(), e.getObjects()));
        return new AjaxResult((Exception) e);
    }
